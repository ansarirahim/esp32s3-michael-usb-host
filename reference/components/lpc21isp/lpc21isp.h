...
// ESP32 platform detection
    ...
    defined(__XTENSA__) || defined(__riscv)
#define COMPILE_FOR_ESP32
#define COMPILED_FOR "ESP32"
...
#if !defined(COMPILE_FOR_LPC21) && !defined(COMPILE_FOR_ESP32)
#define AD_SUPPORT
...
#define TRACE(x) ESP_LOGD("lpc21isp", "%s", x)
...
// Stub implementations for ESP32 (no keyboard input)
...
#if defined COMPILE_FOR_ESP32
    // CDC-ACM device handle will be set via adapter
    void *cdc_dev;  // Placeholder, actual device managed by adapter
#endif // defined COMPILE_FOR_ESP32
...
#else
#if defined COMPILE_FOR_ESP32
// For ESP32: Disable DebugPrintf to avoid heap corruption during programming
// DebugPrintf uses printf/vprintf which allocate heap memory
// This macro replaces the function, so the function should not be defined
#define DebugPrintf(level, ...) ((void)0)
#else
...
#if defined COMPILE_FOR_LINUX || defined COMPILE_FOR_ESP32
#define stricmp strcasecmp
#define strnicmp strncasecmp
#endif // defined COMPILE_FOR_LINUX || defined COMPILE_FOR_ESP32
